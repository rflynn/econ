...
declare -r referer='https://fred.stlouisfed.org/series/FYGDP'
...
declare -r url="https://fred.stlouisfed.org/graph/fredgraph.csv?bgcolor=%23e1e9f0&chart_type=line&drp=0&fo=open%20sans&graph_bgcolor=%23ffffff&height=450&mode=fred&recession_bars=on&txtcolor=%23444444&ts=12&tts=12&width=1168&nt=0&thu=0&trc=0&show_legend=yes&show_axis_titles=yes&show_tooltip=yes&id=FYGDP&scale=left&cosd=1930-06-30&coed=2017-09-30&line_color=%234572a7&link_values=false&line_style=solid&mark_type=none&mw=3&lw=2&ost=-99999&oet=99999&mma=0&fml=a&fq=Annual%2C%20Fiscal%20Year&fam=avg&fgst=lin&fgsnd=2009-06-01&line_index=1&transformation=lin&vintage_date=$yyyy-$mm-$dd&revision_date=$yyyy-$mm-$dd&nd=1930-06-30"

declare -r destdir=./data/raw/$yyyy
mkdir -p $destdir

declare -r destfile=$destdir/$ts-FYGDP.csv
